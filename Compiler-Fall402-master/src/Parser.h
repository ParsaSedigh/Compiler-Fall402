...
class Parser
{
    ...
    Expr *parseTerm();
    Expr *parseFactor();
    Expr *parseFactor_and();
    Expr *parseFactor_eq_neq();
    Expr *parseFactor_GE_LE();
    Expr *parseFactor_G_L();
    Expr *parseFactor_plus_minus();
    Expr *parseFactor_mul_div_perc();
    Expr *parseFactor_power();
    Expr *parseFactor_terminals();
